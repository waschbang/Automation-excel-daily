/**
 * Profile-level daily metrics pipeline.
 *
 * Fetches Sprout Social profile-level analytics for every Customer Group
 * and writes per-group rows (Date x Network) to the matching Drive
 * spreadsheet. Exported as `run()` for bin/run.js.
 */
...
// Import utilities
const apiUtils = require('../clients/sprout');
...
const instagram = require('../platforms/profile/instagram');
const youtube = require('../platforms/profile/youtube');
const linkedin = require('../platforms/profile/linkedin');
const facebook = require('../platforms/profile/facebook');
const twitter = require('../platforms/profile/twitter');
...
const main = async (options = {}) => {
  try {
    ...
    try {
      ...
      const { authenticateWithEnv } = require('../clients/googleAuth');
