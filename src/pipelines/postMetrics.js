/**
 * Post-level analytics pipeline.
 *
 * For each Customer Group, fetches per-post metrics from Sprout Social
 * and writes to `<network>_post` tabs in the matching Drive spreadsheet.
 * Exported as `run()` for bin/run.js.
 */
...
const igPosts = require('../platforms/post/instagram');
const liPosts = require('../platforms/post/linkedin');
const fbPosts = require('../platforms/post/facebook');
const twPosts = require('../platforms/post/twitter');
const ytPosts = require('../platforms/post/youtube');
...
const POSTS_URL = _cfg.sprout.postsUrl;
