...
1. **[HANDOVER.md](HANDOVER.md)** — operational reference: architecture, EC2 setup, runbook, 10 known bugs ranked by impact
2. **[REFACTOR_PLAN.md](REFACTOR_PLAN.md)** — phased refactor blueprint; single source of truth for the migration
